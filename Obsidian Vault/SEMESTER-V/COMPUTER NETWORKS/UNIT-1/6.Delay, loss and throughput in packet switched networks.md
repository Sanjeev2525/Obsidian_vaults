...
let <font style="color:red">'a'</font> denote the average rate at which packets arrive at the queue(p/s) .
...
Thus, for this simple two-link network, the throughput is min{Rc, Rs}, that is, it is the transmission rate of the <font style="color:pink">bottleneck link.</font>
